...
class Menu:
    def __init__(self, screen):
        self.screen = screen
        self.vscomputer = ui.Button(screen, Config.width//2, Config.height//2, 200, 80, "vs AI")
        ...
        self.title = ui.TextUI(self.screen, "", Config.width//1.2, Config.height//6, 140, (255, 255, 255))
